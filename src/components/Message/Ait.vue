      ...
      <div class="line-box" v-for="item of info" :key="item.id" @click="Link({
        ...
        <div class="content-box">
          <div class="head-box">
            ...
            <span>{{ item.actor.id ? "评论" : "文章" }}中@了我</span>
          </div>
          <div class="he-box">
            <span>回复</span>
          ...
          <div class="bottom-box">
            ...
            <div>
              ...
              <span class="delete" @click.stop="Del(item.id)">
...
export default {
  ...
  methods: {
    ...
    async element() {
      const { data } = await this.Fetch.Home.Notify({ method: "post", type: 2 })
